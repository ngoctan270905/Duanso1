    ...
    <div class="navbar-brand-box">
        ...
        <a href="index.html" class="logo logo-light">
            ...
            <span class="logo-lg mt-4">
                <h1 class="display-7 mt-4" style="color: #ffffff !important; display: inline;">No8</h1>
                <h1 class="display-7 mt-4" style="color: #ff0000 !important; display: inline;">Fashion</h1>
            </span>
